(:: pragma bea:global-element-parameter parameter="$testFault1" element="ns2:testFault" location="../../NorthBoundInterfaces/hellodata_1_1.xsd" ::)
(:: pragma bea:global-element-return element="ns0:Fault" location="../schemas/commonsoapfault.xsd" ::)

declare namespace xf = "http://soa.o2.co.uk/Hello_1_1/transformation/TestFaultFaultResponse/";
